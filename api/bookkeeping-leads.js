// GET /api/bookkeeping-leads — the bookkeeping (junior-finance-hire) inventory
// for the outreach engine.
//
// Reads the bookkeeping blob populated by the bookkeeping pipeline via
// POST /api/upload-bookkeeping-leads. Shape mirrors /api/leads:
//   { generated_at, count, leads:[...] }.
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    console.error('bookkeeping-leads failed:', err);
