// Sibling of upload-leads.js, separate blob key. Receives insurance
// pipeline JSON shape `{generated_at, leads: [...]}` — flat, no
// niches dict. Auth via INSURANCE_UPLOAD_API_KEY (different secret
// from the MSP pipeline's LEADS_UPLOAD_API_KEY).
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    console.error('insurance blob put failed:', err);
