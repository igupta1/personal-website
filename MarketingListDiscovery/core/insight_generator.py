...
class InsightGenerator:
    ...
    PROMPT_TEMPLATE = (
        ...
        'write exactly ONE short insight (1-2 sentences, max 40 words) '
        'explaining why a marketing agency should reach out to them right now. '
        'Base your insight on the company\'s industry/domain and the specific '
        'marketing roles they are hiring for. Focus on the business opportunity '
        '(e.g., "scaling marketing", "building out growth function", '
        '"launching new channels") rather than generic statements.\n\n'
        'Do NOT mention the company name in the insight — it will be displayed '
        'next to the company card. Do NOT start with "This company" or '
        '"They are". Start with an action or observation.\n\n'
