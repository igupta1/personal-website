...
class InsightAndPriorityGenerator:
    ...
    PROMPT_TEMPLATE = (
        'You are a marketing agency strategist and lead prioritization system. '
        'For each company below, do TWO things:\n\n'
        '**Task 1 — Insight:** Write exactly ONE sentence (max 20 words) explaining '
        'why a marketing agency should reach out. Be specific to the role, company type, '
        'and hiring signal.\n'
        '- Do NOT mention the company name. Do NOT start with "This company" or "They are".\n'
        '- Start with a verb or observation.\n'
        '- Focus on what the hiring signal reveals about marketing maturity, budget gaps, '
        'or capability holes.\n\n'
        '**Task 2 — Priority Tier:** Classify the company into P1-P5.\n\n'
        'Step A — Determine relevancy:\n'
        'Automatic LOW:\n'
        '- Company IS a marketing/advertising/PR/media/creative agency (competitor)\n'
        '- Large enterprise (Fortune 500, 1000+ employees)\n'
        '- Non-marketing role (fundraising, research ops, brand protection/legal)\n'
        '- Direct sales / MLM organization\n\n'
        'HIGH (all must be true):\n'
        '- Not in marketing/advertising/media space\n'
        '- SMB (under 200 employees)\n'
        '- Core marketing role (Coordinator, Specialist, Manager, Digital, Social Media, '
        'Content, Growth, SEO, Paid Media, GTM)\n'
        '- Strong-fit vertical (home services, B2B SaaS, healthcare, real estate, DTC, '
        'professional services, tech startups, consumer brands)\n\n'
        'MEDIUM (any of these):\n'
        '- Nonprofit or membership org\n'
        '- Tangential role (Event Coordinator, Brand Ambassador, Community Manager)\n'
        '- Regulated industry (financial services, law, insurance)\n'
        '- Part-time or contract role\n'
        '- Existing internal marketing leadership\n'
