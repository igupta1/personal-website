"""Decision maker lookup using Google Gemini with Search grounding."""
...
class DecisionMakerFinder:
    ...
    PROMPT_TEMPLATE = (
        ...
        'VP of Marketing, Head of Marketing, Head of Growth, Director of '
        'Marketing, Growth Lead, or equivalent senior marketing/growth role.\n'
        '2. ONLY if no dedicated marketing or growth leader can be found '
        'through any publicly verifiable source, then fall back to the '
        'Founder, Co-Founder, or CEO.\n\n'
        'Important: If the company is actively hiring for senior marketing '
        'roles (VP, Director, Head of), that is a signal that a marketing '
        'leader likely already exists or the function reports to someone '
        'specific. Search harder for an existing marketing owner before '
        'falling back to the CEO/Founder.\n\n'
        ...
        'select individual contributors unless they are clearly the most '
    ...
    def __init__(
        ...
        Args:
            api_key: Gemini API key. If None, the SDK reads from
    ...
    async def find_decision_makers(
        ...
        Args:
            companies: List of dicts from the orchestrator's successful
                       results, each with at least a "company" key (name).
    ...
    def _parse_response(
        ...
        Guarantees one result per company in the batch.
        """
