"""Configuration management for MSPSalesDiscovery."""
...
# Load .env from the MSPSalesDiscovery package directory
...
class Config:
    ...
    # Metro areas for search (same rotation pool as ITMSPDiscovery)
    ...
    # SerpAPI query: sales/marketing roles at IT MSP companies
    search_query: str = (
        ...
        '("managed services" OR "managed IT" OR "IT services" OR "MSP" '
