...
class AgencyDecisionMakerFinder:
    """
    Verify marketing agency status, get employee count, and find decision makers
    ...
    PROMPT_TEMPLATE = (
        ...
        'perform THREE tasks:\n\n'
        '**Task 1: Agency Verification**\n'
        'Determine whether the company is a marketing agency, digital marketing agency, '
        'advertising agency, creative agency, media agency, or PR agency that provides '
        'outsourced marketing/advertising services to other businesses.\n\n'
        ...
        'of an actual marketing/advertising agency client, try to identify the underlying '
        'agency client company. If you can identify the agency client, set is_agency to '
        'true and use the agency client\'s name as company_name, their website, employee '
        'count, and decision maker — NOT the staffing agency\'s or job board\'s. '
        'If you cannot identify the underlying agency client, set is_agency to false.\n\n'
        'Companies that are software vendors, in-house marketing teams at non-agency '
        'companies, general staffing firms, or non-marketing consulting firms should be '
        'marked as is_agency: false. Staffing agencies hiring for their own internal '
        'roles (not on behalf of a marketing agency) should also be marked as '
        'is_agency: false.\n\n'
        ...
        'For small agencies (<=100 employees), this is almost always the Owner, CEO, '
        ...
        '- "company_name": string (use the actual agency company name, not the staffing agency)\n'
        '- "is_agency": boolean (true if the company is a marketing/advertising/creative agency)\n'
        ...
        '- "reason": string or null (only if person not found, or if is_agency is false)\n\n'
        'Companies:\n{company_list}'
    )
    ...
    def _parse_response(
        ...
        if parsed:
            for entry in parsed:
                ...
                is_agency = entry.get("is_agency", False)
                ...
                if not is_agency:
                    results_by_company[matched] = DecisionMakerResult(
                        ...
                        is_verified_agency=False,
                        employee_count=emp_count,
                        company_website=company_website,
                        not_found_reason=entry.get("reason", "Not a marketing agency"),
                        raw_text=str(entry),
                    )
                elif person and "not confidently" in person.lower():
                    results_by_company[matched] = DecisionMakerResult(
                        company_name=matched,
                        is_verified_agency=True,
                        employee_count=emp_count,
                        company_website=company_website,
    ...
    def _regex_parse(
        ...
        for company_name in company_names:
            ...
            # Check for agency status in the regex block
            is_agency = "is_agency" not in block.lower() or "true" in block.lower().split("is_agency")[-1][:20]

            results[company_name] = DecisionMakerResult(
                company_name=company_name,
                is_verified_agency=is_agency,
