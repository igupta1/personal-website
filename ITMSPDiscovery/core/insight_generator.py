"""AI-generated outreach insights using Google Gemini for IT MSP leads."""
...
class InsightGenerator:
    """
    Generate 1-sentence outreach insights for companies,
    explaining why an IT MSP should reach out.
    """

    PROMPT_TEMPLATE = (
        'You are an IT Managed Service Provider (MSP) strategist. For each company below, '
        'write exactly ONE sentence (max 20 words) explaining why an IT MSP should reach out. '
